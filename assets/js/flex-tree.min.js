/*! jQuery Flex Tree 1.2.0 2020-08-19 */
 !function(a) {
    ...
    a.fn[b]=function(b) {
        b=a.extend( !0, {
            id:void 0, targetElement:a(this), type:void 0, debug: !1, name:"flex_tree", items: {}

            , className:"flex-tree", buildTree: !0, collapsed: !1, collapsable: !0, addControlOnParent: !0, threeState: !0
        }

        , c, b),
     !1===b.collapsable&&(b.collapsed= !1),
     !1===b.addControlOnParent&&(b.threeState= !1);
    var d;
...
;
e(b),
a(b.targetElement).append(d)
}

else d=b.targetElement,
...
if(b.collapsable&&a("li span.node", d).on("click", function(b) {
    ...
    a('input[type="checkbox"].node', d).on("click", function(b) {
            a(this).removeClass("indeterminate").prop("indeterminate",  !1); var c=a(this); c.parent().find('ul input[type="checkbox"]').each(function() {
    ...
    var f=function() {
        ...
        if(b.length) {
            ...
            d|| !0===a(this).prop("indeterminate")?b.addClass("indeterminate").prop("indeterminate",  !0):b.removeClass("indeterminate").prop("indeterminate",  !1),
            c&&b.prop("checked",  !0).prop("indeterminate",  !1).removeClass("indeterminate"),
            f.apply(b)
        }
    }
    ...
    a('input[type="checkbox"]', d).on("click", f),
    a('input[type="checkbox"].leaf', d).each(function() {
            f.apply(this)
        })
}
}
